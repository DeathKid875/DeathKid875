...
local baseURL = "https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO_NAME/main/" -- เปลี่ยนเป็นของคุณ
local Players = game:GetService("Players")
local plr = Players.LocalPlayer

function GetGame()
    if ID == 1234567890 then -- เปลี่ยนเป็นเกมของคุณ
        return "MyGameScript.lua" -- เปลี่ยนเป็นชื่อสคริปของคุณ
    else
